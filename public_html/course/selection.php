...
<main>
    ...
    <article>
        ...
        <?php
        $result = match (true) {
            ($scorePHP >= 0 && $scorePHP < 8) => 'Unfortunately, you failed the PHP course. Better luck next time!',
            ($scorePHP >= 8 && $scorePHP < 10) => 'You failed the PHP course, but you may tolerate it!',
            ($scorePHP >= 10 && $scorePHP <= 20) => 'You passed the PHP course. Congratulations!',
